class PopupNewCard {
    ...
    close() {
        ...
        //this.form.removeEventListener('submit', () => this.addNewCard(this.form));
        //userButtonAddCard.removeEventListener('click', function () {
          //  new PopupNewCard(document.querySelector('.popup__newcard'), card, formValidator, container, updateData).open();
        //});
    }
    addNewCard(form) {
        this.form = form;
